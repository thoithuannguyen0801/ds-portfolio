        ...
        <div className="mx-auto mt-14 grid max-w-4xl gap-6 lg:grid-cols-2">
          ...
          <Reveal>
            <div className="flex h-full flex-col rounded-lg border border-border bg-card p-8">
              ...
              <h3 className="font-display mt-5 text-xl">Send me an email</h3>
              ...
              <a
                ...
                className="mt-5 break-all font-mono text-sm text-foreground hover:text-accent"
              >
                {profile.email}
              </a>
            ...
            <div className="flex h-full flex-col gap-3">
              {socials.map((s) => (
                <a
                  ...
                  rel="noreferrer"
                  className="group flex items-center gap-4 rounded-lg border border-border bg-card p-4 transition-colors hover:border-foreground/30"
                >
                  <span className="inline-grid h-11 w-11 shrink-0 place-items-center border border-border text-muted-foreground transition-colors group-hover:border-foreground group-hover:text-foreground">
